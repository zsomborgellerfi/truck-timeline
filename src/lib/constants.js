export const TRUCK_DATA = {
  trucks: [
    ...
    {
      name: 'ACA134',
      assignedOrderId: ['order40', 'order41', 'order42', 'order43', 'order44'],
    },
    { name: 'NOK463', assignedOrderId: ['order45', 'order46'] },
    {
      name: 'PDK346',
      assignedOrderId: ['order47', 'order48', 'order49', 'order50', 'order51'],
    },
    {
      name: 'HHA961',
    ...
    {
      name: 'DGS431',
      assignedOrderId: ['order56', 'order57', 'order58', 'order59', 'order60'],
    },
    { name: 'ZCA919', assignedOrderId: ['order61', 'order62', 'order63'] },
    {
      name: 'RLY023',
      assignedOrderId: ['order64', 'order65', 'order66', 'order67', 'order68'],
    },
  ],
  orders: [
